 ...
 *
 */
package br.edu.opet.ouvidoria.jdbc;
...
public class Conexao
{
    ...
    /* Métodos da classe */
    // Método para caso a conexão ainda não tenha ido efetuada, faz a conexão e armazena no atributo estático
    ...
    public static void desconectar()
    {
        try
        {
            // Desconectando do banco de dados e verificando se a desconeção foi bem realizada
    ...
    // Método para desfazer as alterções efetuadas em uma transação
